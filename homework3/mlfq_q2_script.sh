...
echo
python3 mlfq.py -n 3 -q 10 -l 0,180,0:100,20,1 -i 5 -c
echo
echo "Press Enter to continue..."
read
...
echo
python3 mlfq.py -n 3 -q 10 -l 0,180,0:100,20,1:100,20,1 -i 5 -c
echo
echo "Press Enter to continue..."
read
...
echo
python3 mlfq.py -n 3 -q 10 -l 0,180,0:100,20,1:100,20,1 -i 5 -B 100 -c
echo
echo "Press Enter to continue..."
read
...
echo
python3 mlfq.py -n 3 -q 10 -l 0,200,0:0,100,9 -i 1 -S -c
echo
echo "Press Enter to continue..."
read
...
echo
python3 mlfq.py -n 3 -q 10 -l 0,200,0:0,100,9 -i 1 -c
echo
echo "Press Enter to continue..."
read
...
echo
python3 mlfq.py -n 3 -Q 10,20,40 -l 0,200,0:50,50,0 -c
echo
